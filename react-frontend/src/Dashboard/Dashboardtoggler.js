    ...
    <div className="maindiv1">
      <div className="optionsdiv1">
          <div className="welcomediv1">
            <div className="welcomeicon1"><BsIcons.BsPersonBoundingBox /></div> 
            <div className="welcometext1">Welcome Admin</div>
          </div>
          <hr className="separator1"/>
          <div className="dashboarddiv1">
            <div className="dashboardicon1"><BsIcons.BsColumnsGap /></div> 
          ...
          <div className="list1">
              ...
              <Link to="/payrollmgmt" style={{ textDecoration: 'none' }} className="linkitem1">
              ...
              <Link to="/projectmgmt" style={{ textDecoration: 'none' }} className="linkitem1">
              <div><BiIcons.BiTask /></div><div>&emsp; Project Management</div></Link>
           
          
              <Link to="/support" style={{ textDecoration: 'none' }} className="linkitem1">
              <div><MdIcons.MdContactPhone /></div><div>&emsp; Support</div></Link>
            
              <Link to="/about" style={{ textDecoration: 'none' }} className="linkitem1">
