...
export default class UpdateEmployeeComponent extends Component {
  ...
  updateEmployees = (e) => {
    ...
    EmployeeService.updateEmployee(this.state.id, employee).then((resp) => {
    ...
    return (
      <div>
        <h3 className="text-center">
          Update Employee with id : {this.state.id}
        </h3>
        <Form style={{ margin: "20px" }}>
          ...
          <button className="btn btn-success" onClick={this.updateEmployees}>
            Submit
          </button>
          <button
